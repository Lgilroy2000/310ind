...
//each problem has a list of keywords associated with it
        ...
        master = (Arrays.asList(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P18, P19, P20,P21,P22,P23));
        ...
        String S21 = "Chatbot: here are some recent tweets from Linus tech tips";
        String S22 = "Chatbot: switching to french";
        String S23 = "Chatbot: switching to english";
        String S24 = "abc";
        String S25 = "abc";
        String S26 = "abc";
        String S27 = "abc";
